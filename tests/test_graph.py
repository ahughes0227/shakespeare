...
import pytest
from shakespeare.runtime.graph import WorkflowGraph, resume, run_with_graph, sqlite_checkpointer
...
class TestDurability:
    ...
    def test_the_opt_out_is_explicit(self, tmp_path: Path, monkeypatch) -> None:
        from shakespeare.runtime.graph import disable_autotracing
